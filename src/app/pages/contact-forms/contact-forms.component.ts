    ...
    this.api.post_private('v1/contacts/update', param).then((data: any) => {
      ...
      if (data && data.status && data.status == 200) {
        ...
        const param = {
          ...
          subject: this.util.generalSettings.name + ' ' + this.util.translate('Replied on your mail'),
          thank_you_text: this.util.translate('You have received new mail'),
          header_text: this.util.generalSettings.name + ' ' + this.util.translate('Replied on your mail'),
          email: this.email,
